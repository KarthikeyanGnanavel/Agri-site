...
$image=$_POST['image'];	
 ...
 $query = "INSERT INTO sell (cropname, quantity, mail, cropprice, mobile, address1, address2, image) 
  		  VALUES('$cropname','$quantity', '$mail', '$cropprice', '$mobile', '$address1', '$address2', '$image')";
